...
<html>
    ...
    <body>
        ...
        <div id="content">
          <div id="site-title">
            <a href="/admin/epoch"><button id="back-button" class="edit-form-data buttons"><span id="test" class="arrow_carrot-left_alt2"></span>Zurück</button></a>
              ...
              <div id="edit-form-wrapper">
                ...
                <form id="edit-form"  action="/admin/person/create" method="post" enctype="multipart/form-data">
                  ...
                  <div id="form-video">
                    ...
                    <span id="video-add"> Videos der Epoche hinzufügen </span>
